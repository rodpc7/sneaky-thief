...
public class Guard : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerVisibleTimer>=timeToSpotPlayer)
        {
            if(OnGuardHasSpottedPlayer != null)
            {
                ...
                OnGuardHasSpottedPlayer();//ativa o evento caso na seja null
                StopAllCoroutines();
            }
        }
    }
    ...
    IEnumerator FollowPath(Vector3[] waypoints)//Faz a itera��o
    {
        ...
        int targetWaypointIndex = 1;//Passa o index para 1
        ...
        while (true)//Loop Infinito
        {
            ...
            if(transform.position== targetWaypoint)//Se estiver no local correto entra passa ao seguinte
            {
